...
export default function ChatPage() {
    ...
    const [messages, setMessages] = useState([
        { id: 1, content: "Hey! How is the FastAPI backend coming along?", sender: "John", timestamp: "10:30 PM", isMe: false },
        { id: 2, content: "It's going great! Just finished the WebSocket integration with Neon.", sender: "Asad", timestamp: "10:31 PM", isMe: true },
        { id: 3, content: "I can help you optimize those queries if you need.", sender: "AI Assistant", timestamp: "10:31 PM", isMe: false, isAi: true },
    ]);
        ...
        <>
            ...
            <footer className="p-4 bg-background">
                <div className="max-w-4xl mx-auto flex items-end gap-2 bg-muted/50 rounded-lg p-2 border focus-within:ring-1 focus-within:ring-ring">
                    ...
                    <Button size="icon" className="shrink-0 bg-blue-600 hover:bg-blue-700 cursor-pointer" onClick={handleSendMessage}>
